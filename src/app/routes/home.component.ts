...
@Component({
  ...
  template: `
    <section class="grid grid-cols-1 md:grid-cols-2 container mx-auto my-10">
      ...
      <div class="flex flex-col items-center md:items-start -md:text-center gap-2 px-4 py-10">
        ...
        <div class="flex flex-nowrap items-center gap-10 text-start">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 container mx-auto my-10 p-4">
